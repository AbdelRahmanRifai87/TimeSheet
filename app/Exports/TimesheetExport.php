...
class TimesheetExport implements WithMultipleSheets
{
    ...
    public function __construct(array $data, array $headings, array $hiddenColumns = [], array $totals = [], array $weekGroups = [], $perLocationTabs = false)
    {
        $this->data = $data;
        ...
        $this->weekGroups = $weekGroups;
            $this->perLocationTabs = $perLocationTabs;

...
@section('content')
    <div class="flex justify-end mt-2 mb-1 p-1">
        <a href="{{ route('quotation.index') }}" class="bg-gray-500 hover:bg-gray-60 text-white p-1 rounded ">
            Back to Quotations
        </a>
    </div>
                    ...
                    <div class="flex-grow">
                        <div class="editable-field" data-field="name">
                            ...
                            <div class="edit-input hidden">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $quotation->name }}" placeholder="Enter quotation name">
                            </div>
                        </div>
                        <div class="editable-field mt-3" data-field="client_name">
                            ...
                            <div class="edit-input hidden">
                                ...
                                <input type="text"
                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                    value="{{ $quotation->client_name }}" placeholder="Enter client name">
                            </div>
                        </div>
                        <div class="editable-field mt-3" data-field="status">
                            <p class="text-gray-700 display-value">
                                <span class="font-semibold">Status:</span>
                                <span id="quotation-status"
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $quotation->status === 'sent to client' ? 'bg-yellow-100 text-yellow-800' : ($quotation->status === 'finalized' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800') }}">
                            ...
                            <div class="edit-input hidden">
                                ...
                                <select
                                    ...
                                    <option value="in_progress"
                                        {{ $quotation->status === 'in_progress' ? 'selected' : '' }}>In Progress</option>
                                    <option value="finalized" {{ $quotation->status === 'finalized' ? 'selected' : '' }}>
                                        Finalized</option>
                                    <option value="sent to client"
                                        {{ $quotation->status === 'sent to client' ? 'selected' : '' }}>Sent to Client
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="editable-field mt-3" data-field="description">
                            ...
                            <div class="edit-input hidden">
                                ...
                                <textarea
                                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 resize-vertical"
                                    rows="3" placeholder="Enter quotation description">{{ $quotation->description }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        <!-- Edit/Save/Cancel Buttons -->
                        <button type="button" id="editQuotationBtn" class="text-blue-600 hover:text-blue-800"
                            title="Edit Quotation">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button type="button" id="saveQuotationBtn" class="hidden text-green-600 hover:text-green-800"
                            title="Save Changes">
                            <i class="fas fa-check"></i>
                        </button>
                        <button type="button" id="cancelQuotationBtn" class="hidden text-gray-600 hover:text-gray-800"
                            title="Cancel Edit">
                        ...
                        <button type="button" id="toggleQuotationSummaryBtn"
                            ...
                            <i id="quotation-summary-chevron"
